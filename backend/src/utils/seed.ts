...
async function main() {
  ...
  const hotel1 = await prisma.accommodation.create({
    data: {
      ...
      contactPhone: '+91-4865-230504',
      contactEmail: 'munnar@tajhotels.com',
      contactWebsite: 'https://www.tajhotels.com',
      contactAddress: 'Munnar, Kerala 685612, India',
      images: [
        'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800',
      ],
      isGovtApproved: true,
      uploadedBy: govtUser.id,
      uploadedByRole: 'GOVT_DEPARTMENT',
      approvalStatus: 'APPROVED',
    },
  });
  ...
  const restaurant1 = await prisma.accommodation.create({
    data: {
      ...
      contactPhone: '+91-477-2243866',
      contactEmail: 'info@saravanabhavan.com',
      contactAddress: 'Beach Road, Alleppey, Kerala 688012',
      images: [
        'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800',
      ],
      isGovtApproved: false,
      uploadedBy: guide.id,
      uploadedByRole: 'TOURIST_GUIDE',
      approvalStatus: 'APPROVED',
    },
  });
