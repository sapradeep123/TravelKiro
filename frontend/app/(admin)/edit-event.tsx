  ...
  const fetchEvent = async () => {
    try {
      ...
      setFormData({
        ...
        venue: event.venue || '',
        customCountry: event.customCountry || '',
        customState: event.customState || '',
        customArea: event.customArea || '',
        startDate: event.startDate ? event.startDate.split('T')[0] : '',
        endDate: event.endDate ? event.endDate.split('T')[0] : '',
        nearestAirport: event.nearestAirport || '',
        airportDistance: event.airportDistance || '',
        nearestRailway: event.nearestRailway || '',
        railwayDistance: event.railwayDistance || '',
        nearestBusStation: event.nearestBusStation || '',
        busStationDistance: event.busStationDistance || '',
      });
    } catch (error) {
        ...
        <View style={[styles.content, isWeb && styles.webContent]}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerText}>
              ...
              <Text style={styles.subtitle}>Update event information</Text>
            </View>
          </View>
