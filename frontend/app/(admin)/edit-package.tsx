...
export default function EditPackage() {
  ...
  const fetchPackage = async () => {
    try {
      ...
      setFormData({
        ...
        customCountry: pkg.customCountry || '',
        customState: pkg.customState || '',
        customArea: pkg.customArea || '',
      });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error.response?.data?.error || 'Failed to update package');
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <View style={[styles.content, isWeb && styles.webContent]}>
          <View style={styles.header}>
            ...
            <View style={styles.headerText}>
              ...
              <Text style={styles.subtitle}>Update package details</Text>
            </View>
          </View>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                      {existingImageUrls.map((url, index) => (
                        <View key={index} style={styles.existingImageContainer}>
                          <img src={url} style={{ width: 100, height: 100, borderRadius: 8, objectFit: 'cover' }} />
                          <TouchableOpacity
                ...
                {submitting || uploadingImages ? (
                  <>
                    ...
                    <Text style={styles.submitButtonText}>
                      {uploadingImages ? 'Uploading images...' : 'Updating package...'}
                    </Text>
                  </>
                ) : (
                  <>
