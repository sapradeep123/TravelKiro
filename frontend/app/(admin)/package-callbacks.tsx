...
export default function PackageCallbacksScreen() {
  ...
  const loadCallbackRequests = async () => {
    try {
      setLoading(true);
      const data = await packageService.getAllCallbackRequests();
      setRequests(data);
    } catch (error) {
          ...
          <Card style={styles.emptyCard}>
            <Card.Content style={styles.emptyContent}>
              ...
              <Text variant="bodyMedium" style={styles.emptySubtext}>
                Callback requests will appear here when users express interest in packages
              </Text>
            </Card.Content>
          </Card>
        ) : (
