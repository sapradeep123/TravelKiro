    ...
    <div className="animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            required
            disabled={isLoading}
            className="w-full px-4 py-3 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
          />
        </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <button className="btn bg-white border border-border py-3 rounded-lg hover:bg-surface transition-colors">
